...
def lint() -> None:
    ...
    print(f"{separator}\nRunning isort...\n{separator}")
    python_call("isort", ["src/Aldebaran_Learning", "src/tests"])

    print(f"{separator}\nRunning flake8...\n{separator}")
    python_call("flake8", ["src/Aldebaran_Learning"])

    print(f"{separator}\nRunning pydocstyle...\n{separator}")
    python_call(
        "pydocstyle",
        ["src/Aldebaran_Learning/pipelines", "src/Aldebaran_Learning/common"],
    )

    print(f"{separator}\nRunning mypy...\n{separator}")
    python_call(
        "mypy",
        ["src/Aldebaran_Learning/pipelines", "src/tests"],
    )
